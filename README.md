...
Status | Name | Info
:----: | ---- | ----
❎ | ~~`String.prototype.fromCharCode()`~~ | <sub> 🔹 Returns a string from a sequence of Unicode values. <br> 🔹 Cannot return all Unicode characters. Use `String.fromCodePoint()` instead. </sub>
✅ | `String.prototype.charAt()`
✅ | `String.prototype.charCodeAt()`
✅ | `String.prototype.indexOf()`
✅ | `String.prototype.lastIndexOf()`
❎ | ~~`String.prototype.substring()`~~ | <sub> 🔹 Returns a section of a string from a start and an optional end index. <br> 🔹 Almost identical to `String.prototype.slice()`, use it instead. </sub>
✅ | `String.prototype.toLowerCase()`
✅ | `String.prototype.toUpperCase()`
✅ | `String.prototype.valueOf()` | <sub> 🔹 Returns the primitive value of a String object. </sub>
